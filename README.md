...
📊 [Download the interactive dashboard (.pbix file)](dashboards/dashboard_full.pbix) requires [Power BI Desktop](https://www.microsoft.com/en-us/power-platform/products/power-bi/downloads) to open
